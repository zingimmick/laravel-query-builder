...
class BuilderTest extends TestCase
{
    ...
    public function testRelation(): void
    {
        ...
        $expected = Order::query()
            ->where(Order::query()
                ->qualifyColumn('user_id'), $user->getKey())->whereNotNull(
                Order::query()->qualifyColumn('user_id')
            )->where('number', 'like', sprintf('%%%s%%', '2021'))->toSql();
    ...
    public function testClone()
    {
        ...
        self::assertNotSame((clone $query)->whereNotNull('test1')->toSql(), (clone $query)->whereNotNull('test2')->toSql());
    }
    ...
    public function testCloneMethod()
    {
        ...
        self::assertNotSame($query->clone()->whereNotNull('test1')->toSql(), (clone $query)->whereNotNull('test2')->toSql());
    }
